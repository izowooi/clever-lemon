...
class PoetryListPopup extends ConsumerStatefulWidget {
  const PoetryListPopup({super.key});

  @override
  ConsumerState<PoetryListPopup> createState() => _PoetryListPopupState();
}

class _PoetryListPopupState extends ConsumerState<PoetryListPopup> {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            // 작품 목록
            Expanded(
              child: _buildBody(poetryListState),
            ),
          ],
        ),
      ),
                ...
                children: [
                  if (poetry.keywords.isNotEmpty) ...[
                    Expanded(
                      child: Wrap(
                        spacing: 4,
                        children: poetry.keywords.take(2).map((keyword) {
                          return Chip(
                            label: Text(
                              keyword,
